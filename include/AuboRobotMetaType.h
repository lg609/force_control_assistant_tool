...
typedef enum
{
    ...
    ErrCode_CreateRequestFailed,        /** 创建请求失败　5**/
    ...
    ErrCode_MotionInterruptedByEvent,        /** 运动被事件中断　21**/
    ErrCode_MotionWaypointVetorSizeError,    /** 运动相关的路点容器的长度不符合规定　**/
    ErrCode_ResponseReturnError,             /** 服务器响应返回错误　23**/
